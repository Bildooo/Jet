...
part_type_size(particle1,0.1,0.2,-0.015,0);
part_type_scale(particle1,1.0,1.0);
part_type_color3(particle1,65535,8421504,0);
part_type_alpha2(particle1,0.6,0.8);
part_type_speed(particle1,0.2, 0.5, 0.4,0);
part_type_direction(particle1,270, 270,0,0);
part_type_gravity(particle1,0.01,270);
part_type_orientation(particle1,0,0,0,0,1);
part_type_blend(particle1,0.8);
